...
const cubos_stock = [];
//PRODUCTOS, DISEÑOS 
cubos_stock.push(new Productos(1, " 3 x 3",  "MoYu", 779.99, 'img/moyu_3x3.jpg'));
cubos_stock.push(new Productos(2, " 3 x 3",  "Qiyi", 889.99, 'img/qiyi_3x3.jpg'));
cubos_stock.push(new Productos(3, " 2 x 2",  "MoYu", 649.99, ' img/moyu_2x2.jpg'));
console.table(cubos_stock);

//Aplicando Storage a los productos del carrito
const guardarLocal =(clave, valor)=>{localStorage.setItem(clave,valor)}

guardarLocal("ListaProductos", JSON.stringify(cubos_stock));
...
cubos_stock.forEach((info) => {
  ...
  card_cuerpo.appendChild(modelo_card)
